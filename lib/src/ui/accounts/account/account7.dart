...
class _UserAccountState extends State<UserAccount> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Theme.of(context).brightness == Brightness.light
          ? Color(0xFFf2f3f7).withOpacity(0.2)
          : Colors.black,
      body: Stack(
        children: [
          CustomScrollView(
                            ...
                            onPressed: () {
                              if (appStateModel.user?.id != null &&
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            AdminChatPage(userId: appStateModel.user.id.toString())));
                              } else {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              title: Text(
                                appStateModel.blocks.localeText.wishlist
                                    .toUpperCase(),
                                style: menuTextStyle,
                              ),
                              trailing: Icon(
                            ...
                            ListTile(
                              ...
                              leading: ExcludeSemantics(
                                  child: Icon(
                                      MStoreIcons.shopping_basket_2_fill)),
                              title: Text(
                            ...
                            ListTile(
                              ...
                              leading: ExcludeSemantics(
                                  child: Icon(MStoreIcons.location)),
                              title: Text(
                                appStateModel.blocks.localeText.address
                                    .toUpperCase(),
                                style: menuTextStyle,
                              ),
                              trailing: Icon(
                            ...
                            ListTile(
                              ...
                              leading: ExcludeSemantics(
                                  child: Icon(MStoreIcons.settings)),
                              title: Text(
                                    ...
                                    return Column(
                                      children: <Widget>[
                                        ListTile(
                                          ...
                                          title: Text(
                                            model.blocks.localeText.language
                                                .toUpperCase(),
                                            style: menuTextStyle,
                                          ),
                                          trailing: Icon(
                                    ...
                                    return Column(
                                      children: <Widget>[
                                        ListTile(
                                          ...
                                          title: Text(
                                            model.blocks.localeText.currency
                                                .toUpperCase(),
                                            style: menuTextStyle,
                                          ),
                                          trailing: Icon(
                            ...
                            ListTile(
                              onTap: () {
                                if (appStateModel.user?.id != null &&
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              ChatRoomList(id: appStateModel.user.id.toString())));
                                } else {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                              ...
                              title: Text(appStateModel.blocks.localeText.chat.toUpperCase(),
                                style: menuTextStyle,
                              ),
                              trailing: Icon(
                                Icons.arrow_forward_ios,
              ...
              flexibleSpace: FlexibleSpaceBar(
                  ...
                  title: Row(
                    children: [
                      ...
                      Container(
                          child: (appStateModel.user?.id != null &&
                              appStateModel.user.id > 0)
                              ? (appStateModel.user.billing.firstName != '' ||
                              appStateModel.user.billing.lastName !=
                                  '')
                              ? Text(
                            appStateModel.user.billing.firstName +
                                ' ' +
                            ...
                            style: TextStyle(color: onPrimaryColor),
                              ...
                              : Container(
                            child: Text(
                              appStateModel.blocks.localeText.welcome,
                              style:
              ...
              return Container(
                ...
                children: <Widget>[
                  ListTile(
                    ...
                    title: Text(pages[index].title, style: menuTextStyle,),
                    trailing:
                    Icon(Icons.arrow_forward_ios, size: 15),
                  ),
                  Divider(height: 0.0),
  ...
  _shareApp() {
    if (Platform.isIOS) {
      ...
      Share.share(
          'check out thia app: ' + appStateModel.blocks.settings.shareAppIosLink);
    } else {
      //Add android app link here
      Share.share(
          'check out thia app: ' + appStateModel.blocks.settings.shareAppAndroidLink);
    }
  }
