    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          Expanded(
            child: GoogleMap(
              initialCameraPosition: CameraPosition(target: widget.displayLocation ?? LatLng(26.1826, 28.0040), zoom: 12),
  ...
  void decodeAndSelectPlace(AutoCompleteItem aci) async {
    ...
    try {
      final response = await http
          .get("https://maps.googleapis.com/maps/api/place/details/json?key=${widget.apiKey}" + "&placeid=" + aci.id);
