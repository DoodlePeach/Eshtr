...
class PlacePickerState extends State<PlacePicker> {
  ...
  void initState() {
    ...
    if(appStateModel.customerLocation.containsKey('latitude') && appStateModel.customerLocation['latitude'] != null && appStateModel.customerLocation['longitude'] != null) {
          ...
          Expanded(
            ...
            child: ScopedModelDescendant<AppStateModel>(
                builder: (context, child, model) {
                  ...
                  return GoogleMap(
                  initialCameraPosition: model.customerLocation.containsKey('latitude') && model.customerLocation.containsKey('latitude') != null ? CameraPosition(target: LatLng(double.parse(model.customerLocation['latitude']), double.parse(model.customerLocation['longitude'])), zoom: 8) : CameraPosition(target: LatLng(30.5595, 22.9375), zoom: 8),
                  ...
                  child: FlatButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text('Use currrent location', style: Theme.of(context).textTheme.bodyText1.copyWith(
                              color: Colors.orange
                          ),),
                        ],
                      )
  ...
  void decodeAndSelectPlace(String placeId) async {
    ...
    try {
      final response = await http
          .get("https://maps.googleapis.com/maps/api/place/details/json?key=${config.mapApiKey}" + "&placeid=$placeId");
