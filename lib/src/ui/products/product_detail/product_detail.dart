...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Widget buildLisOfReleatedProducts() {
    ...
    return StreamBuilder<ReleatedProductsModel>(
        ...
        builder: (context, AsyncSnapshot<ReleatedProductsModel> snapshot) {
          if (snapshot.hasData) {
            return ProductScroll(products: snapshot.data.relatedProducts, context: context, title: title);
          } else {
  ...
  Widget buildLisOfCrossSellProducts() {
    ...
    return StreamBuilder<ReleatedProductsModel>(
        ...
        builder: (context, AsyncSnapshot<ReleatedProductsModel> snapshot) {
          if (snapshot.hasData) {
            return ProductScroll(products: snapshot.data.crossProducts, context: context, title: title);
          } else {
            return SliverToBoxAdapter();
          }
        });
  ...
  Widget buildLisOfUpSellProducts() {
    ...
    return StreamBuilder<ReleatedProductsModel>(
        ...
        builder: (context, AsyncSnapshot<ReleatedProductsModel> snapshot) {
          if (snapshot.hasData) {
            return ProductScroll(products: snapshot.data.upsellProducts, context: context, title: title);
          } else {
            return SliverToBoxAdapter();
          }
        });
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            ...
                            title: Text('Customer Reviews (${snapshot.data.length})',
