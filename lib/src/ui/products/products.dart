...
class _ProductsWidgetState extends State<ProductsWidget>
  ...
  _onSelectSubcategory(int id) {
    widget.productsBloc.productsFilter['id'] = id.toString();
    widget.productsBloc.fetchAllProducts();
    _scrollController.jumpTo(0.0);
    setState(() {
      selectedCategory = subCategories[_tabController.index];
      ...
      body: Stack(
        ...
        children: [
          Container(
              ...
              child: CustomPaint(
                painter:CurvePainter(color: Theme.of(context).brightness == Brightness.light ? Colors.red : Theme.of(context).primaryColor,),
              )),
              StreamBuilder(
