            ...
            children: <Widget>[
              SizedBox(
                ...
                child: new RaisedButton(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: new BorderRadius.only(topLeft: Radius.circular(4), bottomLeft: Radius.circular(4)),
                  ),
              ...
              SizedBox(
                ...
                child: new RaisedButton(
                  ...
                  child: isLoading ? SizedBox(
                    child: CircularProgressIndicator(strokeWidth: 2, valueColor: new AlwaysStoppedAnimation<Color>(Theme.of(context).buttonTheme.colorScheme.onPrimary),),
                    height: 20.0,
                    width: 20.0,
                  ) :  SizedBox(
                    width: 20.0,
              ...
              SizedBox(
                ...
                child: new RaisedButton(
                  elevation: 0,
                  shape: RoundedRectangleBorder(
                    borderRadius: new BorderRadius.only(topRight: Radius.circular(4), bottomRight: Radius.circular(4)),
                  ),
