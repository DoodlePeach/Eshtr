...
import '../../../src/ui/accounts/login/button_text.dart';
...
class _CheckoutOnePageState extends State<CheckoutOnePage> {
  ...
  List<Widget> slivers(AsyncSnapshot<OrderReviewModel> snapshot, BuildContext context, AppStateModel model) {
    ...
    list.add(
        SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(24.0, 16.0, 24.0, 8.0),
              child: Text(widget.appStateModel.blocks.localeText.paymentMethod,
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                RaisedButton(
                  child: ButtonText(isLoading: isLoading, text: widget
                      ...
                      if (snapshot.hasData &&
                        ...
                        return Center(
                          child: Container(
                              ...
                              child: Text(
                                  parseHtmlString(snapshot.data.messages),
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
          ...
          return RadioListTile<String>(
            ...
            title: Text(
                snapshot.data.shipping[i].shippingMethods[index].label +
                    ' ' +
                    parseHtmlString(snapshot
                        .data.shipping[i].shippingMethods[index].cost)),
          );
        },
          ...
          return Padding(
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(width: cWidth,child: Text(parseHtmlString(snapshot.data.paymentMethods[index].title))),
              ],
            ),
          );
        },
  ...
  openWebView(String url) {
    Navigator.push(context, MaterialPageRoute(builder: (context) =>
        WebViewPage(
            url: url, selectedPaymentMethod: widget.homeBloc.formData['payment_method']
        )
    ));
  }
