              ...
              Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const SizedBox(height: 16.0),
                    Text(appStateModel.blocks.localeText.type, style: Theme.of(context).textTheme.subhead),
                    Row(
                      children: <Widget>[
                        Radio<String>(
                          value: 'simple',
                    ...
                    const SizedBox(height: 16.0),
                    Text(appStateModel.blocks.localeText.catalogVisibility, style: Theme.of(context).textTheme.subhead),
                    Row(
                      children: <Widget>[
                        Radio<String>(
                          value: 'visible',
                    ...
                    const SizedBox(height: 16.0),
                    Text(appStateModel.blocks.localeText.stockStatus, style: Theme.of(context).textTheme.subhead),
                    Row(
                      children: <Widget>[
                        Radio<String>(
                          value: 'instock',
                    ...
                    const SizedBox(height: 16.0),
                    Text(appStateModel.blocks.localeText.backOrder, style: Theme.of(context).textTheme.subhead),
                    Row(
                      children: <Widget>[
                        Radio<String>(
                          value: 'no',
