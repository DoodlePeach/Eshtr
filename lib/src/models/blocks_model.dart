...
class LocaleText {
  ...
  factory LocaleText.fromJson(Map<String, dynamic> json) => LocaleText(
    ...
    dontHaveAnAccount: json["Dont have an account"] == null ?"Dont have an account": json["Dont have an account"],
    ...
    inValidCode: json["Invalid Code"] == null ?"Invalid Code": json["Invalid Code"],
...
class Settings {
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
    ...
    whatsappNumber: json["whatsapp_number"] == null ? '123456789' : json["whatsapp_number"],
