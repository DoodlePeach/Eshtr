...
class AppStateModel extends Model {
  ...
  getLocalData() async {
    ...
    if (prefs.getString('language_code') == null) {
      appLocale = Locale('en');
    } else appLocale = Locale(prefs.getString('language_code'));
  ...
  void setPickedLocation(Map<String, dynamic> result) {
  ...
  Future<bool> login(data) async {
    ...
    if (response.statusCode == 200) {
      ...
      if(user.id != null && user.id > 0) {
        ...
        apiProvider.post('mstore_flutter_update_user_notification', {'onesignal_user_id': playerId});
        loggedIn = true;
      }
      notifyListeners();
      return true;
      ...
      Fluttertoast.showToast(gravity: ToastGravity.TOP, msg: parseHtmlString(error.data[0].message));
      return false;
    } else {
      return false;
    }
  ...
  Future<bool> addToCart(data) async {
    ...
    if (response.statusCode == 200) {
      ...
      Fluttertoast.showToast(msg: notice.data[0].notice);
    }
  }
